...
function ProductListPage() {
    ...
    const onSubmit = (latitude, longitude, index) => {
        ...
        axios.get( 'http://localhost:8000/items?latitude='+latitude+'&longitude='+longitude+'&page='+index ,
            {headers: {
    ...
    const addSubmit = (latitude, longitude) => {
        axios.get( 'http://localhost:8000/items?latitude='+latitude+'&longitude='+longitude+'&page='+page ,
            {headers: {
                    Authorization: 'Bearer ' + sessionStorage.getItem("token")
                }}
            ,
